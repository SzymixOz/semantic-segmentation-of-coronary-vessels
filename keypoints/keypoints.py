...
def find_keypoints_on_graph(skeleton: np.ndarray) -> Tuple[np.ndarray, list, list, list, list]:
    ...
    return coordinates, endpoints, crossings, filtered_branchpoints, filtered_out

def draw_everything_else(image_binary: np.ndarray, skeleton: np.ndarray, coordinates: Tuple[np.ndarray, np.ndarray], endpoints: list, crossings: list, filtered_branchpoints: list, filtered_out: list) -> None:
    """
